...
<html lang="vi">
    <head>
        <meta charset="UTF-8">
        <title>Đăng ký Tổ Chức - MasterTicket</title>
        <style>
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <main class="main-content">
            <div class="register-card">
                <h2 class="register-title">Đăng Ký Tổ Chức Sự Kiện</h2>
                ...
                <form action="registerOrganizer" method="post" enctype="multipart/form-data" class="register-form">
                    <div class="form-group">
                        <label for="email">Email tổ chức</label>
                        <input type="email" id="email" name="email" placeholder="Nhập email tổ chức" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="organizationName">Tên tổ chức</label>
                        <input type="text" id="organizationName" name="organizationName" placeholder="Nhập tên tổ chức" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="contactNumber">Số liên hệ</label>
                        <input type="text" id="contactNumber" name="contactNumber" placeholder="Nhập số điện thoại" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="officeAddress">Địa chỉ văn phòng</label>
                        <input type="text" id="officeAddress" name="officeAddress" placeholder="Nhập địa chỉ văn phòng" required>
                    </div>

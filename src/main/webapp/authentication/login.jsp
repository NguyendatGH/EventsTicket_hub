...
<body>
    <div class="login-box">
        ...
        <!-- Google Sign-In -->
        <div id="g_id_onload"
             data-client_id="938914428868-1185k9iis1ne5qh7vgqtjse96q055t2g.apps.googleusercontent.com"
             data-context="signin"
             data-ux_mode="redirect"
             data-login_uri="http://localhost:8080/OnlineSellingTicketEvents/google-login"

            ...
            <div class="content-section">
                ...
                <div class="event-list">
                    <c:choose>
                        <c:when test="${not empty activeEvents}">
                            <c:forEach var="event" items="${activeEvents}" begin="${(currentPage-1)*pageSize}" end="${currentPage*pageSize-1}">
                                <div class="event-item">
                                    <div class="event-info">
                                        <h3><c:out value="${event.name}" /></h3>
                                        <p>
                        ...
                        <c:otherwise>
                            <div class="event-item" style="text-align: center;">
                                <p style="color: #9ca3af;">No active events found.</p>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
                ...
                <div class="pagination" style="display: flex; justify-content: center; margin-top: 20px;">
                    <c:if test="${currentPage > 1}">
                        <a href="?page=${currentPage-1}" class="btn" style="margin: 0 5px;">&laquo; Previous</a>
                    </c:if>

                    <c:forEach begin="1" end="${totalPages}" var="i">
                        <c:choose>
                            <c:when test="${i == currentPage}">
                                <span class="btn btn-primary" style="margin: 0 5px;">${i}</span>
                            </c:when>
                            <c:otherwise>
                                <a href="?page=${i}" class="btn" style="margin: 0 5px;">${i}</a>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>

                    <c:if test="${currentPage < totalPages}">
                        <a href="?page=${currentPage+1}" class="btn" style="margin: 0 5px;">Next &raquo;</a>
                    </c:if>
                </div>
            </div>

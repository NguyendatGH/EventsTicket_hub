            ...
            <form action="${pageContext.request.contextPath}/organizer-servlet" method="post" id="eventForm">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <label class="form-label">Has Seating Chart</label>
                        <input type="checkbox" class="form-input" name="hasSeatingChart" value="true" ${event.hasSeatingChart ? 'checked' : ''}>
                    </div>
                </div>
                <div class="action-buttons">
                    <a href="${pageContext.request.contextPath}/organizer-servlet?action=step2" class="btn-secondary">← Back</a>

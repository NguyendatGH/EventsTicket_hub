...
<%
    // Retrieve the User object (which is an event_owner in this context) from session
    User user = (User) session.getAttribute("user");
    if (user == null || !"event_owner".equals(user.getRole())) { // CORRECTED ROLE CHECK HERE
        response.sendRedirect("login"); // Redirect if not logged in or not an event_owner
        return;
    }
...
<html lang="vi">
    <head>
        ...
        <style>
            /* Your entire CSS block from the original updateProfile.jsp goes here */
            /* This ensures consistency in styling */
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <header class="header">
            <div class="nav-container">
                <a href="${pageContext.request.contextPath}/userPage/userHomePage" class="logo">MasterTicket</a>
                ...
                <div class="user-menu">
                    <div class="user-info" onclick="toggleUserDropdown()">
                        <%-- Avatar display for standard User --%>
                    ...
                    <div class="user-dropdown" id="userDropdown">
                        ...
                        <a href="${pageContext.request.contextPath}/LogoutServlet" class="dropdown-item" style="color: #ff6b6b;">🚪 Đăng xuất</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <nav class="nav-menu">
            <div class="nav-links">
                <a href="${pageContext.request.contextPath}/userPage/userHomePage" class="active">Trang Chủ</a>
                <a href="${pageContext.request.contextPath}/events">Các sự kiện hot</a>
                <a href="${pageContext.request.contextPath}/vouchers">Sản voucher giảm giá</a>
                <a href="${pageContext.request.contextPath}/create-event">Tạo sự kiện</a> <%-- This link is common --%>
            ...
            <div class="profile-container">
                ...
                <form method="post" action="${pageContext.request.contextPath}/updateProfile" enctype="multipart/form-data">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="username" name="username"
                                   ...
                                   placeholder="Tên người dùng" readonly style="opacity: 0.7;">
                        </div>
                    ...
                    <div class="button-group">
                        ...
                        <a href="${pageContext.request.contextPath}/changePassword" class="btn-secondary">Đổi mật khẩu</a>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            <% } else { %>
            avatarPreview.dataset.currentAvatar = '';
            <% } %>
        });
    </script>
</html>
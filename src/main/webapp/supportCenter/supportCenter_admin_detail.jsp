...
;
    ...
    /* height: 3vw; */
        ...
        .attachment-btn.download { background: #667aff; color: white; }
        .attachment-btn.download:hover { background: #5566dd; }
        .attachment-btn.view { background: #00cc66; color: white; }
        .attachment-btn.view:hover { background: #00b359; }
        ...
        @media (max-width: 700px) { 
            ...
            .card, .admin-response-form { padding: 1rem 0.5rem; } 
                                ...
                                <c:forEach var="attachment" items="${supportItem.attachments}">
                                    <div class="attachment-item">
                                        ...
                                        <div class="attachment-actions">
                                            <a href="${pageContext.request.contextPath}/admin/support?action=download&fileId=${attachment.attachmentId}" class="attachment-btn download" title="Tải xuống">
                                                <i class="fas fa-download"></i>
                                            </a>
                                            <a href="${pageContext.request.contextPath}/admin/support?action=view&fileId=${attachment.attachmentId}" class="attachment-btn view" title="Xem file" target="_blank">

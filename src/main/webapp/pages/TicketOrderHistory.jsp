    ...
    <body>
        ...
        <script>
            ...
            function loadNotifications() {
                ...
                fetch('${pageContext.request.contextPath}/notification-servlet?action=getNotifications&userId=' + userId)
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (userId > 0) {
                    ...
                    fetch('${pageContext.request.contextPath}/notification-servlet?action=getUnreadCount&userId=' + userId)
                        .then(response => response.json())
                        .then(data => {

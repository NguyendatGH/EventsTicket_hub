...
<html lang="vi">
  ...
  <body>
    <img class="bg_elips firstElement" src="<%= request.getContextPath() %>/asset/full.svg" />
    <img class="bg_elips secondElement" src="<%= request.getContextPath() %>/asset/full2.svg" />
    <div class="container">
      <aside class="sidebar">
          ...
          <c:otherwise>
            <div class="event-option">
              <button class="btn approve">
                Phê duyệt
                <img src="${pageContext.request.contextPath}/asset/accept.svg" class="btn-img" alt="Phê duyệt" />
              </button>
              <button class="btn reject">
                Từ chối
                <img src="${pageContext.request.contextPath}/asset/Trash.svg" class="btn-img" alt="Từ chối" />
              </button>
            </div>
          </c:otherwise>
        </c:choose>
